  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "rgba(109, 40, 217, 0.45)", backdropFilter: "blur(12px)", border: "1px solid rgba(167, 139, 250, 0.3)" }}
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {message && (
            <div
              className="w-full text-white text-center py-3 px-4 rounded-xl text-sm"
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl px-4 py-3 text-gray-800 font-medium focus:outline-none focus:ring-2 focus:ring-purple-300"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-xl px-4 py-3 pr-14 text-gray-800 font-medium focus:outline-none focus:ring-2 focus:ring-purple-300"
                style={{ background: "rgba(255,255,255,0.15)", border: "1px solid rgba(167,139,250,0.5)", color: "white" }}
                placeholder="••••••••••••"
                required
              />
              <button
                ...
                style={{ background: "rgba(109,40,217,0.7)", border: "1px solid rgba(167,139,250,0.5)" }}
              >
                {showPassword ? (
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full font-bold py-4 rounded-xl text-lg text-white transition duration-200 disabled:opacity-60"
