...
export default function Home() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>): void => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Login successful! Welcome to IT Assets Management System.');
    }, 1500);
  };
  ...
  const handleStaffLogin = (): void => {
    alert('Staff login portal will be available soon!');
  };

  // Inline styles with proper TypeScript
  ...
  const staffLinkContainerStyle: React.CSSProperties = { 
    textAlign: 'center', 
    marginTop: '2rem' 
  };

  const staffButtonStyle: React.CSSProperties = {
    background: 'none',
    border: 'none',
    color: '#c4b5fd',
    fontSize: '0.875rem',
